  ...
  return (
    <section id="home" className="min-h-screen relative flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden">
        <span
          className="text-[10vw] md:text-[8vw] font-black uppercase tracking-[0.3em] text-white/[0.03] font-sans whitespace-nowrap"
      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          {/* Geometric callout labels */}
          <div className="flex flex-wrap gap-4">
            <div className="flex items-center gap-2">
              <div className="w-6 h-px bg-secondary" />
              <span className="text-xs font-mono text-secondary border border-secondary/30 px-2 py-0.5 rounded">IT Undergraduate</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-6 h-px bg-primary" />
              <span className="text-xs font-mono text-primary border border-primary/30 px-2 py-0.5 rounded">Software Development</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <a
              ...
              download
              className="inline-flex items-center justify-center px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-md hover:bg-primary/90 transition-all hover:scale-105 active:scale-95 box-glow-primary font-mono text-sm"
            >
            ...
            <div className="flex space-x-3 items-center">
              ...
              <a
                ...
                className="p-3 rounded-md bg-card/50 border border-white/10 hover:border-secondary hover:text-secondary transition-colors"
                title="LinkedIn"
              >
        ...
        >
          <div className="relative w-72 h-72 md:w-96 md:h-96">
            ...
            <div className="absolute -right-4 top-10 bg-card/80 backdrop-blur-md border border-secondary/30 p-3 rounded-lg shadow-xl font-mono text-sm transform rotate-3">
              <div className="text-secondary font-bold text-xs">GPA</div>
              <div className="text-foreground text-sm">3.49 / 4.00</div>
            </div>
            ...
            <div className="absolute -left-8 bottom-20 bg-card/80 backdrop-blur-md border border-primary/30 p-3 rounded-lg shadow-xl font-mono text-sm transform -rotate-6">
              <div className="text-primary font-bold text-xs">EXPECTED</div>
              <div className="text-foreground text-sm">2027</div>
            </div>
          </div>
        </motion.div>
      </div>
