...
import {
  ...
  Layers, Cpu, FileCode, Braces, Box,
...
const categories = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "RESTful APIs", icon: Network, color: "#38bdf8" },
      { name: "MVC", icon: Settings, color: "#60d9ff" },
      { name: "Hibernate", icon: Database, color: "#8b9ca7" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "MongoDB", icon: Hash, color: "#5fa04e" },
    ]
  },
  {
    id: "05",
    ...
    <section id="skills" className="py-24 relative bg-black/20 overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground font-mono text-xs mt-2 ml-6">// 6 categories · full stack toolkit</p>
        </motion.div>
                  ...
                  return (
                    ...
                    >
                      <NeonRing className="w-12 h-12 mb-2 transition-transform group-hover:scale-110">
                        <Icon className="w-6 h-6 transition-all duration-300" style={{ color: skill.color }} />
                      </NeonRing>
